                ...
                <div class="card-body">
                    <form action="<c:url value='/save'/>" method='POST'>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Укажите имя нарушителя">
                        </div>
                        <div class="form-group mb-3">
                            <label for="text" class="form-label">Описание нарушения</label>
                            <input type="text" class="form-control" id="text" name="text" placeholder="Опишите нарушение">
                        </div>
                        <div class="form-group mb-3">
